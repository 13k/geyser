...
type APIGen struct {
	baseName       string
	interfaces     schema.InterfacesGroup
	groupedMethods map[string]schema.MethodsGroup
	methodsNames   []string
	appIDs         []uint32
	requiredAppID  bool
	undoc          bool
...
func NewAPIGen(interfaces schema.InterfacesGroup, pkgPath, pkgName, outputDir, basefile string) (*APIGen, error) {
